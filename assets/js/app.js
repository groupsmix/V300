...
function openDrawer() {
    ...
    links += '<a href="/browse" class="drawer__item">🔍 Smart Filter</a>';
    links += '<div class="drawer__divider"></div>';
...
function renderFooter() {
    ...
    footer.innerHTML = '<div class="site-footer">' +
        ...
        '<a href="/browse" class="site-footer__link">Smart Filter</a>' +
...
function renderMobileNav() {
    ...
    nav.innerHTML = '<a href="/" class="mobile-nav__item' + (path === '/' ? ' active' : '') + '"><span class="mobile-nav__icon">🏠</span><span class="mobile-nav__label">Home</span></a>' +
        ...
        '<a href="/browse" class="mobile-nav__item' + (path.startsWith('/browse') || path.startsWith('/category') || path.startsWith('/country') || path.startsWith('/platform') ? ' active' : '') + '"><span class="mobile-nav__icon">🔍</span><span class="mobile-nav__label">Smart Filter</span></a>' +
